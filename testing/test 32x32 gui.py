...
# # #colour button
allwhite = Button(frame3, text="All White",font=("Calibri, 10"), bg='white', width=13, height=2, command=allwht)
allwhite.grid(row=0, column=0)

allblack = Button(frame3, text="All Black",font=("Calibri, 10"), bg='black', fg='white', width=13, height=2, command=allblk)
allblack.grid(row=0, column=1)

xpattern = Button(frame3, text="X Pattern",font=("Calibri, 10"), bg='gold', width=13, height=2, command=pattern)
xpattern.grid(row=0, column=2)

seq = Button(frame3, text="Sequence",font=("Calibri, 10"), bg='#ff007f', width=13, height=2, command=ramseq)
seq.grid(row=0, column=3)

#send btn
send = Button(frame4, text="Send Imaged!", font=("Calibri, 10"), width=13, height=2, command=sendbtn)
