...
def ramseq():
  button[0][0].config(bg='white')
  button[0][1].config(bg='#f3f3f3')
  button[0][2].config(bg='#dedede')
  button[1][0].config(bg='#cccccc')
  button[1][1].config(bg='#999999')
  button[1][2].config(bg='#666666')
  button[2][0].config(bg='#222222')
  button[2][1].config(bg='black')
  button[2][2].config(bg='white')
